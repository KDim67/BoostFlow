              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@boostflow.ai" className="text-blue-600 dark:text-blue-400 hover:underline">info@boostflow.ai</a>
                    <p className="text-gray-600 dark:text-gray-300 mt-2 mb-2">For support:</p>
                    <a href="mailto:support@boostflow.ai" className="text-blue-600 dark:text-blue-400 hover:underline">support@boostflow.ai</a>
                  </div>
                </div>
