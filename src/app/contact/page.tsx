...
export const metadata = {
  title: 'Contact Us - BoostFlow',
  description: 'Get in touch with the BoostFlow team for questions, support, or to schedule a demo.',
};
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@boostflow.me" className="text-blue-600 dark:text-blue-400 hover:underline">info@boostflow.me</a>
                    <p className="text-gray-600 dark:text-gray-300 mt-2 mb-2">For support:</p>
                    <a href="mailto:support@boostflow.me" className="text-blue-600 dark:text-blue-400 hover:underline">support@boostflow.me</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-2">Sales:</p>
                    <a href="tel:+1-800-123-4567" className="text-blue-600 dark:text-blue-400 hover:underline">+1 (800) 123-4567</a>
                    <p className="text-gray-600 dark:text-gray-300 mt-2 mb-2">Support:</p>
                    <a href="tel:+1-800-765-4321" className="text-blue-600 dark:text-blue-400 hover:underline">+1 (800) 765-4321</a>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://github.com/KDim67/BoostFlow" className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800/30 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 text-gray-600 dark:text-gray-300">Join thousands of teams that use BoostFlow to streamline their workflow and enhance collaboration.</p>
