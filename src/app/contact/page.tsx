              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+1-800-123-4567" className="text-blue-600 dark:text-blue-400 hover:underline">sales phone number</a>
                    <p className="text-gray-600 dark:text-gray-300 mt-2 mb-2">Support:</p>
                    <a href="tel:+1-800-765-4321" className="text-blue-600 dark:text-blue-400 hover:underline">support phone number</a>
                  </div>
                </div>
